  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Currency & Region</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Card style={styles.card}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{answers.country || 'N/A'}</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.row}>
            <Text style={styles.label}>City</Text>
            <Text style={styles.value}>{answers.city || 'N/A'}</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.row}>
            <Text style={styles.label}>Primary Currency</Text>
            <Text style={styles.value}>{answers.currency || 'MAD'}</Text>
          </View>
        </Card>
      </ScrollView>
    </SafeAreaView>
